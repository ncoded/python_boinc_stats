#THIS CODE DOWNLOADS THE COMPRESSED STATS FILE FROM A BOINC PROJECT, 
#PARSES THE XML FILE, BUILDS A DATA DICTIIONARY, SORTS IT, 
#AND THEN WRITES IT INTO A CSV FILE (AND READS IT BACK IN)
